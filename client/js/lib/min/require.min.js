...
var cds={};
cds.userMinified=false;
cds.getParamVal = function(name) {
    name = name.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
   	var regex = new RegExp(name);
    result = regex.test(location.href);
    return result;
}
cds.isIndebugMode = cds.getParamVal("debug=1");
cds.depModuleRootPath = cds.isIndebugMode? "min" : "modules";
